...
export function LandingPage({ systemTitle, primaryColor, footerText, onStart }: LandingPageProps) {
      ...
      <div className="landing-container">
        <header className="landing-header landing-header-glass">
          ...
          <nav className="landing-nav">
            <button type="button" onClick={() => document.getElementById('blog-list-anchor')?.scrollIntoView({ behavior: 'smooth' })}>博客广场</button>
            <button type="button" onClick={() => document.getElementById('blog-detail-anchor')?.scrollIntoView({ behavior: 'smooth' })}>精选文章</button>
        ...
        <section className="landing-blog-hero">
          <div className="landing-blog-hero-copy">
            ...
            <Typography.Title className="landing-blog-title">
              把文章内容真正用起来，首页就是你的博客门面。
            </Typography.Title>
            <Typography.Paragraph className="landing-blog-subtitle">
              支持按博客分类筛选、关键词搜索、分页浏览和沉浸式详情阅读。风格参考现代产品博客首页，走干净、大气、可读性强那一路。
            ...
            <Space wrap>
              ...
              <Button size="large" onClick={onStart}>登录管理博客</Button>
            </Space>
          </div>
        ...
        <section id="blog-list-anchor" className="landing-blog-toolbar-card">
          <div className="landing-blog-toolbar-top">
            <div>
              ...
              <Typography.Paragraph>分类筛选、搜索和分页都给你配上了，未登录用户照样能看。</Typography.Paragraph>
            </div>
            <Input
