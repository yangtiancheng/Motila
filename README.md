...
- 首页当前采用极简终端风格首屏，默认展示 `Welcome to Motila.` / `Hello World.` 动效
- 顶部保留 `立即开始` 主入口，点击后跳转 `/login`
- 顶部「博文 / 文档 / 社区」为预留导航，当前点击提示“暂未开放，先别急。”
...
- 未登录首页升级为公开博客首页：支持分类筛选、关键词搜索、分页浏览、沉浸式文章详情，并复用系统配置 Footer 文案
